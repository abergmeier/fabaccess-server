...
pub mod user_system {
  ...
  pub type InfoParams<> = ::capnp::capability::Params<crate::schema::usersystem_capnp::user_system::info_params::Owned>;
  pub type InfoResults<> = ::capnp::capability::Results<crate::schema::usersystem_capnp::user_system::info_results::Owned>;
  pub type ManageParams<> = ::capnp::capability::Params<crate::schema::usersystem_capnp::user_system::manage_params::Owned>;
  pub type ManageResults<> = ::capnp::capability::Results<crate::schema::usersystem_capnp::user_system::manage_results::Owned>;
  ...
  impl  Client {
    pub fn info_request(&self) -> ::capnp::capability::Request<crate::schema::usersystem_capnp::user_system::info_params::Owned,crate::schema::usersystem_capnp::user_system::info_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, None)
    }
    pub fn manage_request(&self) -> ::capnp::capability::Request<crate::schema::usersystem_capnp::user_system::manage_params::Owned,crate::schema::usersystem_capnp::user_system::manage_results::Owned> {
  ...
  pub mod info {
    ...
    pub type GetUserSelfResults<> = ::capnp::capability::Results<crate::schema::usersystem_capnp::user_system::info::get_user_self_results::Owned>;
    ...
    impl  Client {
      pub fn get_user_self_request(&self) -> ::capnp::capability::Request<crate::schema::usersystem_capnp::user_system::info::get_user_self_params::Owned,crate::schema::usersystem_capnp::user_system::info::get_user_self_results::Owned> {
        self.client.new_call(_private::TYPE_ID, 0, None)
      }
    }
    pub trait Server<>   {
    ...
    pub mod get_user_self_results {
      ...
      mod _private {
        ...
        pub const TYPE_ID: u64 = 0xb1bf_8c1a_3514_95f6;
      }
    }
  }
  ...
  pub mod manage {
    ...
    pub type AddUserResults<> = ::capnp::capability::Results<crate::schema::usersystem_capnp::user_system::manage::add_user_results::Owned>;
    ...
    impl  Client {
      ...
      pub fn add_user_request(&self) -> ::capnp::capability::Request<crate::schema::usersystem_capnp::user_system::manage::add_user_params::Owned,crate::schema::usersystem_capnp::user_system::manage::add_user_results::Owned> {
        self.client.new_call(_private::TYPE_ID, 1, None)
      }
    ...
    pub mod add_user_results {
      ...
      mod _private {
        use capnp::private::layout;
        pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 1 };
        pub const TYPE_ID: u64 = 0xb55b_3841_289d_1685;
      }
    }
  ...
  pub mod info_params {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 0 };
      pub const TYPE_ID: u64 = 0xbb8b_0f51_8ae5_00b7;
    }
  }
  ...
  pub mod info_results {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 1 };
      pub const TYPE_ID: u64 = 0xb303_06be_9d64_7746;
    }
  }
  ...
  pub mod manage_params {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 0 };
      pub const TYPE_ID: u64 = 0xbf53_3c1e_c4b4_a8d3;
    }
  }
  ...
  pub mod manage_results {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 1 };
      pub const TYPE_ID: u64 = 0xda93_03ae_556e_6504;
    }
  }
}
